...
public class PirateRenderer : MonoBehaviour {
	...
	private void Update() {
		...
		_renderer.sprite = _sprites[_animationSet.GetCorrectedFrame(_animation, _animationsPerPirate * _pirateIndex)];
	}

	public Sprite GetDefaultSprite() => _sprites[_animationsPerPirate * _pirateIndex];
}